    ...
    const Lessons = (function() {
        const lessons = {
            ...
            '1.3': {
                ...
                content: '<h3>Reading Limits from Visual Records</h3><p>To find $\\lim_{x \\to c} f(x)$ from a graph:</p><ol><li>Locate $x = c$ on the horizontal axis</li><li>Trace the curve from the left, noting where the $y$-value heads</li><li>Trace the curve from the right, noting where the $y$-value heads</li><li>If both sides approach the same $y$-value, that\'s the limit</li></ol><h3>Interactive Exploration</h3><p>Drag the point to see how $f(x)$ values change as $x$ approaches 2. Notice the function has a <em>hole</em> at $x = 2$, but the limit still exists!</p><div class="limit-visualizer" data-function="rational" data-limit-point="2" data-limit-value="4"><canvas width="600" height="300"></canvas></div><div class="key-concept"><strong>Remember:</strong> Look at where the curve is <em>heading</em>, not where it actually is at $x = c$. A hole in the graph doesn\'t prevent a limit from existing!</div><h3>Cases to Recognize</h3><div class="concept-grid"><figure class="concept-figure"><svg viewBox="0 0 200 140" xmlns="http://www.w3.org/2000/svg"><line class="grid-line" x1="20" y1="80" x2="180" y2="80"/><line class="grid-line" x1="100" y1="20" x2="100" y2="140"/><line class="axis" x1="20" y1="80" x2="180" y2="80"/><line class="axis" x1="100" y1="20" x2="100" y2="140"/><path class="curve" d="M 30 30 Q 100 80 170 130"/><circle class="point" cx="100" cy="80" r="3.5"/><text class="label-axis" x="105" y="135">c</text><text class="label-axis" x="92" y="78">L</text></svg><figcaption>Continuous: limit = f(c)</figcaption></figure><figure class="concept-figure"><svg viewBox="0 0 200 140" xmlns="http://www.w3.org/2000/svg"><line class="grid-line" x1="20" y1="80" x2="180" y2="80"/><line class="grid-line" x1="100" y1="20" x2="100" y2="140"/><line class="axis" x1="20" y1="80" x2="180" y2="80"/><line class="axis" x1="100" y1="20" x2="100" y2="140"/><path class="curve" d="M 30 30 L 95 75"/><path class="curve" d="M 105 75 L 170 130"/><circle class="point-open" cx="100" cy="80" r="4"/><text class="label-axis" x="105" y="135">c</text><text class="label-axis" x="92" y="78">L</text></svg><figcaption>Hole: limit exists, f(c) undefined</figcaption></figure><figure class="concept-figure"><svg viewBox="0 0 200 140" xmlns="http://www.w3.org/2000/svg"><line class="grid-line" x1="20" y1="80" x2="180" y2="80"/><line class="grid-line" x1="100" y1="20" x2="100" y2="140"/><line class="axis" x1="20" y1="80" x2="180" y2="80"/><line class="axis" x1="100" y1="20" x2="100" y2="140"/><path class="curve" d="M 30 110 L 100 110"/><path class="curve" d="M 100 50 L 170 50"/><circle class="point" cx="100" cy="110" r="3.5"/><circle class="point-open" cx="100" cy="50" r="4"/><text class="label-axis" x="105" y="135">c</text></svg><figcaption>Jump: one-sided limits differ</figcaption></figure><figure class="concept-figure"><svg viewBox="0 0 200 140" xmlns="http://www.w3.org/2000/svg"><line class="grid-line" x1="20" y1="80" x2="180" y2="80"/><line class="grid-line" x1="100" y1="20" x2="100" y2="140"/><line class="axis" x1="20" y1="80" x2="180" y2="80"/><line class="axis" x1="100" y1="20" x2="100" y2="140"/><line class="helper-line" x1="100" y1="20" x2="100" y2="140"/><path class="curve" d="M 30 75 Q 80 78 95 25"/><path class="curve" d="M 105 135 Q 120 82 170 85"/><text class="label-axis" x="105" y="135">c</text></svg><figcaption>Asymptote: limit is &plusmn;&infin;</figcaption></figure></div>'
            },
            '1.4': {
                id: '1.4',
            ...
            '1.8': {
                ...
                content: '<h3>The Squeeze Theorem</h3><div class="definition"><strong>Squeeze Theorem:</strong> If $g(x) \\leq f(x) \\leq h(x)$ near $c$, and $\\lim_{x \\to c} g(x) = \\lim_{x \\to c} h(x) = L$, then $\\lim_{x \\to c} f(x) = L$</div><figure class="concept-figure"><svg viewBox="0 0 320 200" xmlns="http://www.w3.org/2000/svg"><line class="axis" x1="20" y1="170" x2="300" y2="170"/><line class="axis" x1="160" y1="20" x2="160" y2="190"/><path class="curve-bound" d="M 30 30 Q 160 130 290 30"/><path class="curve-bound" d="M 30 170 Q 160 60 290 170"/><path class="curve" d="M 30 95 Q 80 165 160 95 Q 240 25 290 95"/><circle class="point" cx="160" cy="95" r="3.5"/><text class="label" x="295" y="32">h(x)</text><text class="label" x="295" y="172">g(x)</text><text class="label" x="265" y="92">f(x)</text><text class="label-axis" x="165" y="195">c</text><text class="label-axis" x="148" y="93">L</text></svg><figcaption>f(x) is squeezed between g(x) and h(x); since both bounds approach L at x = c, so does f.</figcaption></figure><div class="example"><div class="example-header">Example</div><p>Find $\\lim_{x \\to 0} x^2 \\sin(\\frac{1}{x})$</p><p>Since $-1 \\leq \\sin(\\frac{1}{x}) \\leq 1$: $-x^2 \\leq x^2\\sin(\\frac{1}{x}) \\leq x^2$</p><p>Both bounds → 0, so by Squeeze Theorem, limit = 0</p></div><div class="key-concept"><strong>Key Bounds:</strong> $-1 \\leq \\sin(\\cdot) \\leq 1$ and $-1 \\leq \\cos(\\cdot) \\leq 1$</div>'
            },
            '1.9': {
                id: '1.9',
            ...
            '1.10': {
                ...
                content: '<h3>Three Types of Discontinuities</h3><div class="concept-grid"><figure class="concept-figure"><svg viewBox="0 0 200 140" xmlns="http://www.w3.org/2000/svg"><line class="axis" x1="20" y1="80" x2="180" y2="80"/><line class="axis" x1="100" y1="20" x2="100" y2="140"/><path class="curve" d="M 30 30 L 95 75"/><path class="curve" d="M 105 75 L 170 130"/><circle class="point-open" cx="100" cy="80" r="4"/><text class="label-axis" x="105" y="135">c</text></svg><figcaption><strong>Removable:</strong> a single hole in an otherwise smooth curve.</figcaption></figure><figure class="concept-figure"><svg viewBox="0 0 200 140" xmlns="http://www.w3.org/2000/svg"><line class="axis" x1="20" y1="80" x2="180" y2="80"/><line class="axis" x1="100" y1="20" x2="100" y2="140"/><path class="curve" d="M 30 110 L 100 110"/><path class="curve" d="M 100 50 L 170 50"/><circle class="point" cx="100" cy="110" r="3.5"/><circle class="point-open" cx="100" cy="50" r="4"/><text class="label-axis" x="105" y="135">c</text></svg><figcaption><strong>Jump:</strong> left and right limits exist but differ.</figcaption></figure><figure class="concept-figure"><svg viewBox="0 0 200 140" xmlns="http://www.w3.org/2000/svg"><line class="axis" x1="20" y1="80" x2="180" y2="80"/><line class="axis" x1="100" y1="20" x2="100" y2="140"/><line class="helper-line" x1="100" y1="20" x2="100" y2="140"/><path class="curve" d="M 30 75 Q 80 78 95 25"/><path class="curve" d="M 105 135 Q 120 82 170 85"/><text class="label-axis" x="105" y="135">c</text></svg><figcaption><strong>Infinite:</strong> the curve has a vertical asymptote at c.</figcaption></figure></div><div class="example"><div class="example-header">Examples</div><p>Removable: $\\frac{x^2-1}{x-1}$ at $x=1$</p><p>Jump: $\\lfloor x \\rfloor$ at integers</p><p>Infinite: $\\frac{1}{x}$ at $x=0$</p></div>'
            },
            '1.11': {
                id: '1.11',
            ...
            '1.14': {
                ...
                content: '<h3>Vertical Asymptotes</h3><div class="definition"><strong>Vertical Asymptote:</strong> $x = c$ is a VA if $\\lim_{x \\to c^+}$ or $\\lim_{x \\to c^-}$ is $\\pm\\infty$</div><figure class="concept-figure"><svg viewBox="0 0 320 200" xmlns="http://www.w3.org/2000/svg"><line class="axis" x1="20" y1="100" x2="300" y2="100"/><line class="axis" x1="40" y1="20" x2="40" y2="180"/><line class="helper-line" x1="200" y1="20" x2="200" y2="180"/><path class="curve" d="M 50 95 Q 150 100 195 25"/><path class="curve" d="M 205 175 Q 250 105 290 102"/><text class="label-axis" x="290" y="115">x</text><text class="label-axis" x="205" y="190">x = c</text><text class="label" x="60" y="60">f(x) = 1/(x &minus; c)</text></svg><figcaption>As x approaches c from the right, f(x) &rarr; +&infin;; from the left, f(x) &rarr; &minus;&infin;.</figcaption></figure><h3>Finding Vertical Asymptotes</h3><p>For $\\frac{p(x)}{q(x)}$: Find where $q(x) = 0$ and $p(x) \\neq 0$</p><div class="example"><div class="example-header">Example</div><p>$f(x) = \\frac{1}{x-3}$:</p><p>VA at $x = 3$</p><p>$\\lim_{x \\to 3^+} = +\\infty$ (small positive denominator)</p><p>$\\lim_{x \\to 3^-} = -\\infty$ (small negative denominator)</p></div>'
            },
            '1.15': {
                id: '1.15',
                title: 'Connecting Limits at Infinity and Horizontal Asymptotes',
                content: '<h3>End Behavior</h3><div class="definition"><strong>Horizontal Asymptote:</strong> $y = L$ is a HA if $\\lim_{x \\to \\pm\\infty} f(x) = L$</div><figure class="concept-figure"><svg viewBox="0 0 320 200" xmlns="http://www.w3.org/2000/svg"><line class="axis" x1="20" y1="160" x2="300" y2="160"/><line class="axis" x1="160" y1="20" x2="160" y2="180"/><line class="helper-line" x1="20" y1="70" x2="300" y2="70"/><path class="curve" d="M 25 130 Q 90 95 160 75 Q 230 70 295 70"/><text class="label-axis" x="290" y="172">x</text><text class="label" x="265" y="65">y = L</text></svg><figcaption>As x &rarr; &plusmn;&infin;, the curve flattens toward the horizontal line y = L.</figcaption></figure><h3>Rational Functions at Infinity</h3><div class="key-concept">For $\\frac{a_nx^n + ...}{b_mx^m + ...}$:<ul><li>$n < m$: HA at $y = 0$</li><li>$n = m$: HA at $y = \\frac{a_n}{b_m}$</li><li>$n > m$: No HA</li></ul></div><div class="example"><div class="example-header">Example</div><p>$\\lim_{x \\to \\infty} \\frac{3x^2 + 1}{5x^2 - 2} = \\frac{3}{5}$ (equal degrees)</p></div>'
            },
            '1.16': {
                id: '1.16',
                title: 'Working with the Intermediate Value Theorem',
                content: '<h3>The Intermediate Value Theorem</h3><div class="definition"><strong>IVT:</strong> If $f$ is continuous on $[a, b]$ and $k$ is between $f(a)$ and $f(b)$, then there exists $c$ in $(a, b)$ where $f(c) = k$.</div><figure class="concept-figure"><svg viewBox="0 0 320 200" xmlns="http://www.w3.org/2000/svg"><line class="axis" x1="20" y1="170" x2="300" y2="170"/><line class="axis" x1="40" y1="20" x2="40" y2="190"/><path class="curve" d="M 60 150 C 100 30, 200 180, 280 50"/><line class="helper-line" x1="40" y1="100" x2="280" y2="100"/><line class="helper-line" x1="60" y1="150" x2="60" y2="170"/><line class="helper-line" x1="280" y1="50" x2="280" y2="170"/><line class="helper-line" x1="170" y1="100" x2="170" y2="170"/><circle class="point" cx="60" cy="150" r="3.5"/><circle class="point" cx="280" cy="50" r="3.5"/><circle class="point" cx="170" cy="100" r="4"/><text class="label-axis" x="55" y="185">a</text><text class="label-axis" x="275" y="185">b</text><text class="label-axis" x="166" y="185">c</text><text class="label" x="20" y="103">k</text><text class="label" x="15" y="153">f(a)</text><text class="label" x="285" y="55">f(b)</text></svg><figcaption>A continuous curve from f(a) to f(b) must cross every height k in between &mdash; so some c in (a, b) gives f(c) = k.</figcaption></figure><h3>Using IVT to Find Roots</h3><div class="example"><div class="example-header">Example</div><p>Show $x^3 + x - 1 = 0$ has a solution in $(0, 1)$:</p><ol><li>$f(x) = x^3 + x - 1$ is continuous (polynomial)</li><li>$f(0) = -1 < 0$</li><li>$f(1) = 1 > 0$</li><li>Since $f(0) < 0 < f(1)$, by IVT there exists $c$ where $f(c) = 0$</li></ol></div><div class="key-concept"><strong>IVT Requirements:</strong> Function must be continuous, and target value must be between $f(a)$ and $f(b)$.</div>'
            },
            // ========== UNIT 2: DIFFERENTIATION ==========
            '2.1': {
                id: '2.1',
                title: 'Defining Average and Instantaneous Rates of Change',
                content: '<h3>Rates of Change</h3><p>The Clocktower\'s astronomers tracked celestial movements by measuring how positions changed over time.</p><div class="definition"><strong>Average Rate of Change:</strong> $$\\frac{f(b) - f(a)}{b - a}$$</div><div class="definition"><strong>Instantaneous Rate of Change:</strong> $$\\lim_{h \\to 0} \\frac{f(a+h) - f(a)}{h}$$</div><figure class="concept-figure"><svg viewBox="0 0 320 200" xmlns="http://www.w3.org/2000/svg"><line class="axis" x1="20" y1="170" x2="300" y2="170"/><line class="axis" x1="40" y1="20" x2="40" y2="190"/><path class="curve" d="M 50 165 Q 130 145 180 95 T 290 25"/><line class="secant" x1="60" y1="162" x2="280" y2="35"/><line class="tangent" x1="105" y1="190" x2="245" y2="20"/><circle class="point" cx="80" cy="155" r="3.5"/><circle class="point" cx="260" cy="47" r="3.5"/><circle class="point" cx="180" cy="95" r="4"/><text class="label-axis" x="76" y="185">a</text><text class="label-axis" x="256" y="185">b</text><text class="label" x="245" y="105">tangent (instantaneous)</text><text class="label" x="60" y="135">secant (average)</text></svg><figcaption>The secant\'s slope is the average rate over [a, b]; the tangent\'s slope is the instantaneous rate at a single point.</figcaption></figure><p>The instantaneous rate is the limit of average rates as the interval shrinks to zero.</p><div class="example"><div class="example-header">Example</div><p>For $f(x) = x^2$ at $x = 3$:</p><p>Instantaneous rate $= \\lim_{h \\to 0} \\frac{(3+h)^2 - 9}{h} = \\lim_{h \\to 0} \\frac{6h + h^2}{h} = 6$</p></div>'
            },
            '2.2': {
                id: '2.2',
            ...
            '2.4': {
                ...
                content: '<h3>Differentiability and Continuity</h3><div class="key-concept"><strong>Key Theorem:</strong> If $f$ is differentiable at $a$, then $f$ is continuous at $a$.</div><p>The converse is FALSE: continuous does not imply differentiable.</p><h3>Where Functions Fail to be Differentiable</h3><ul><li><strong>Corners:</strong> $f(x) = |x|$ at $x = 0$</li><li><strong>Cusps:</strong> $f(x) = x^{2/3}$ at $x = 0$</li><li><strong>Vertical tangents:</strong> $f(x) = \\sqrt[3]{x}$ at $x = 0$</li><li><strong>Discontinuities:</strong> Any discontinuity</li></ul><div class="concept-grid"><figure class="concept-figure"><svg viewBox="0 0 200 140" xmlns="http://www.w3.org/2000/svg"><line class="axis" x1="20" y1="110" x2="180" y2="110"/><line class="axis" x1="100" y1="20" x2="100" y2="130"/><path class="curve" d="M 30 30 L 100 110 L 170 30"/><circle class="point" cx="100" cy="110" r="3.5"/></svg><figcaption>Corner: |x| at x = 0 &mdash; left and right slopes differ.</figcaption></figure><figure class="concept-figure"><svg viewBox="0 0 200 140" xmlns="http://www.w3.org/2000/svg"><line class="axis" x1="20" y1="110" x2="180" y2="110"/><line class="axis" x1="100" y1="20" x2="100" y2="130"/><path class="curve" d="M 30 50 Q 80 60 100 110 Q 120 60 170 50"/><circle class="point" cx="100" cy="110" r="3.5"/></svg><figcaption>Cusp: slopes diverge to &plusmn;&infin; from opposite sides.</figcaption></figure><figure class="concept-figure"><svg viewBox="0 0 200 140" xmlns="http://www.w3.org/2000/svg"><line class="axis" x1="20" y1="70" x2="180" y2="70"/><line class="axis" x1="100" y1="10" x2="100" y2="130"/><path class="curve" d="M 30 130 Q 95 130 100 70 Q 105 10 170 10"/><circle class="point" cx="100" cy="70" r="3.5"/></svg><figcaption>Vertical tangent: slope is undefined (infinite).</figcaption></figure></div><div class="example"><div class="example-header">Example</div><p>$f(x) = |x|$ is continuous everywhere but not differentiable at $x = 0$ (corner).</p></div>'
            },
            '2.5': {
                id: '2.5',
            ...
            '4.6': {
                ...
                content: '<h3>Local Linear Approximation</h3><p>Near any point, a smooth curve looks like its tangent line. We use this for approximation.</p><div class="definition"><strong>Linear Approximation:</strong> $$f(x) \\approx f(a) + f\'(a)(x - a)$$ for $x$ near $a$.</div><figure class="concept-figure"><svg viewBox="0 0 320 200" xmlns="http://www.w3.org/2000/svg"><line class="axis" x1="20" y1="170" x2="300" y2="170"/><line class="axis" x1="40" y1="20" x2="40" y2="190"/><path class="curve" d="M 50 165 Q 160 165 290 30"/><line class="tangent" x1="60" y1="170" x2="290" y2="50"/><circle class="point" cx="170" cy="120" r="4"/><line class="helper-line" x1="170" y1="120" x2="170" y2="170"/><text class="label-axis" x="166" y="185">a</text><text class="label" x="195" y="115">(a, f(a))</text><text class="label" x="220" y="160">f(x)</text><text class="label" x="220" y="80">tangent line</text></svg><figcaption>Near x = a, the curve hugs its tangent line. Use the line\'s value as a quick estimate of f(x).</figcaption></figure><div class="definition"><strong>Differential:</strong> $$dy = f\'(x) \\cdot dx$$ approximates $\\Delta y$</div><div class="example"><div class="example-header">Example</div><p>Approximate $\\sqrt{4.1}$ using $f(x) = \\sqrt{x}$ at $a = 4$:</p><p>$f(4) = 2$, $f\'(4) = \\frac{1}{4}$</p><p>$\\sqrt{4.1} \\approx 2 + \\frac{1}{4}(0.1) = 2.025$</p><p>(Actual: 2.0248...)</p></div>'
            },
            '4.7': {
                id: '4.7',
            ...
            '5.1': {
                ...
                content: '<h3>Mean Value Theorem</h3><p>In the Mining Caverns, the miners knew: between any two depths, there must be a point where the slope of the tunnel equals the average slope between entry points.</p><div class="definition"><strong>Mean Value Theorem:</strong> If $f$ is continuous on $[a,b]$ and differentiable on $(a,b)$, then there exists $c$ in $(a,b)$ such that: $$f\'(c) = \\frac{f(b) - f(a)}{b - a}$$</div><figure class="concept-figure"><svg viewBox="0 0 320 200" xmlns="http://www.w3.org/2000/svg"><line class="axis" x1="20" y1="170" x2="300" y2="170"/><line class="axis" x1="40" y1="20" x2="40" y2="190"/><path class="curve" d="M 60 150 Q 170 30 280 80"/><line class="secant" x1="60" y1="150" x2="280" y2="80"/><line class="tangent" x1="100" y1="100" x2="240" y2="55"/><circle class="point" cx="60" cy="150" r="3.5"/><circle class="point" cx="280" cy="80" r="3.5"/><circle class="point" cx="170" cy="77.5" r="4"/><line class="helper-line" x1="60" y1="150" x2="60" y2="170"/><line class="helper-line" x1="280" y1="80" x2="280" y2="170"/><line class="helper-line" x1="170" y1="77.5" x2="170" y2="170"/><text class="label-axis" x="56" y="185">a</text><text class="label-axis" x="276" y="185">b</text><text class="label-axis" x="166" y="185">c</text><text class="label" x="80" y="135">secant slope</text><text class="label" x="180" y="55">tangent &#8214; secant</text></svg><figcaption>Somewhere in (a, b), the tangent line is parallel to the secant connecting the endpoints.</figcaption></figure><div class="key-concept">The instantaneous rate somewhere equals the average rate over the interval.</div><div class="example"><div class="example-header">Example</div><p>For $f(x) = x^2$ on $[1, 3]$:</p><p>Average rate: $\\frac{9-1}{3-1} = 4$</p><p>$f\'(c) = 2c = 4 \\Rightarrow c = 2$</p></div>'
            },
            '5.2': {
                id: '5.2',
            ...
            '5.6': {
                ...
                content: '<h3>Concavity</h3><div class="definition"><ul><li>$f\'\'(x) > 0$: concave up (holds water)</li><li>$f\'\'(x) < 0$: concave down (spills water)</li></ul></div><div class="concept-grid"><figure class="concept-figure"><svg viewBox="0 0 200 140" xmlns="http://www.w3.org/2000/svg"><line class="axis" x1="20" y1="120" x2="180" y2="120"/><line class="axis" x1="100" y1="20" x2="100" y2="130"/><path class="curve" d="M 30 30 Q 100 170 170 30"/></svg><figcaption>Concave up: f&Prime; &gt; 0 (holds water).</figcaption></figure><figure class="concept-figure"><svg viewBox="0 0 200 140" xmlns="http://www.w3.org/2000/svg"><line class="axis" x1="20" y1="20" x2="180" y2="20"/><line class="axis" x1="100" y1="20" x2="100" y2="130"/><path class="curve" d="M 30 110 Q 100 -30 170 110"/></svg><figcaption>Concave down: f&Prime; &lt; 0 (spills water).</figcaption></figure></div><div class="definition"><strong>Inflection Point:</strong> Where concavity changes (usually where $f\'\' = 0$ or undefined)</div><div class="example"><div class="example-header">Example</div><p>$f(x) = x^3$</p><p>$f\'\'(x) = 6x$</p><p>$f\'\' > 0$ for $x > 0$: concave up</p><p>$f\'\' < 0$ for $x < 0$: concave down</p><p>Inflection at $x = 0$</p></div>'
            },
            '5.7': {
                id: '5.7',
            ...
            '6.1': {
                ...
                content: '<h3>Accumulation Functions</h3><p>Richland Creek flows past campus, carrying water at varying rates. How much water passes a point depends on the flow rate over time.</p><div class="definition"><strong>Accumulation:</strong> If $r(t)$ is a rate of change, then the total change from $a$ to $b$ is: $$\\text{Total Change} = \\int_a^b r(t)\\, dt$$</div><figure class="concept-figure"><svg viewBox="0 0 320 200" xmlns="http://www.w3.org/2000/svg"><line class="axis" x1="20" y1="120" x2="300" y2="120"/><line class="axis" x1="40" y1="20" x2="40" y2="180"/><path class="shaded" d="M 60 120 Q 110 30 160 80 L 160 120 Z"/><path d="M 160 120 Q 220 200 280 140 L 280 120 Z" fill="#A30046" fill-opacity="0.25"/><path class="curve" d="M 60 120 Q 110 30 160 80 Q 220 200 280 140"/><line class="helper-line" x1="60" y1="120" x2="60" y2="140"/><line class="helper-line" x1="280" y1="120" x2="280" y2="140"/><text class="label-axis" x="56" y="155">a</text><text class="label-axis" x="276" y="155">b</text><text class="label" x="240" y="50">r(t)</text><text class="label" x="100" y="95">+</text><text class="label" x="220" y="155">&minus;</text></svg><figcaption>The integral is signed area: above the axis adds, below subtracts. Net accumulation is the running total.</figcaption></figure><div class="example"><div class="example-header">Example</div><p>Water flows at $r(t) = 3t$ gallons/minute. Total water in first 4 minutes:</p><p>$\\int_0^4 3t\\, dt = \\frac{3t^2}{2}\\Big|_0^4 = 24$ gallons</p></div><div class="key-concept">Integration "undoes" differentiation—it accumulates rates into totals.</div>'
            },
            '6.2': {
                id: '6.2',
                title: 'Approximating Areas with Riemann Sums',
                content: '<h3>Riemann Sums</h3><div class="definition"><strong>Approximating Area:</strong> Divide $[a,b]$ into $n$ rectangles of width $\\Delta x = \\frac{b-a}{n}$. $$\\text{Area} \\approx \\sum_{i=1}^n f(x_i^*) \\Delta x$$</div><figure class="concept-figure"><svg viewBox="0 0 320 200" xmlns="http://www.w3.org/2000/svg"><line class="axis" x1="20" y1="170" x2="300" y2="170"/><line class="axis" x1="40" y1="20" x2="40" y2="190"/><rect class="shaded" x="60" y="155" width="35" height="15"/><rect class="shaded" x="95" y="135" width="35" height="35"/><rect class="shaded" x="130" y="110" width="35" height="60"/><rect class="shaded" x="165" y="80" width="35" height="90"/><rect class="shaded" x="200" y="50" width="35" height="120"/><rect class="shaded" x="235" y="30" width="35" height="140"/><rect x="60" y="155" width="35" height="15" fill="none" stroke="#4699C2" stroke-width="1"/><rect x="95" y="135" width="35" height="35" fill="none" stroke="#4699C2" stroke-width="1"/><rect x="130" y="110" width="35" height="60" fill="none" stroke="#4699C2" stroke-width="1"/><rect x="165" y="80" width="35" height="90" fill="none" stroke="#4699C2" stroke-width="1"/><rect x="200" y="50" width="35" height="120" fill="none" stroke="#4699C2" stroke-width="1"/><rect x="235" y="30" width="35" height="140" fill="none" stroke="#4699C2" stroke-width="1"/><path class="curve-alt" d="M 60 162 Q 165 130 270 25"/><text class="label-axis" x="56" y="185">a</text><text class="label-axis" x="266" y="185">b</text><text class="label" x="240" y="60">f(x)</text></svg><figcaption>Each rectangle has width &Delta;x and height f(x*); summing them estimates the area under the curve.</figcaption></figure><div class="key-concept"><strong>Types:</strong><ul><li>Left Riemann: use left endpoint</li><li>Right Riemann: use right endpoint</li><li>Midpoint: use midpoint of each subinterval</li></ul></div><div class="example"><div class="example-header">Example</div><p>$f(x) = x^2$ on $[0, 2]$ with $n = 4$:</p><p>Left sum: $0^2 + 0.5^2 + 1^2 + 1.5^2 \\cdot 0.5 = 1.75$</p></div>'
            },
            '6.3': {
                id: '6.3',
            ...
            '7.3': {
                ...
                content: '<h3>Slope Fields</h3><p>A slope field visualizes a differential equation by showing the slope at each point.</p><div class="definition"><strong>Slope Field:</strong> At each point $(x, y)$, draw a short segment with slope $= f(x, y)$ where $\\frac{dy}{dx} = f(x, y)$.</div><figure class="concept-figure"><svg viewBox="0 0 240 200" xmlns="http://www.w3.org/2000/svg"><line class="axis" x1="20" y1="100" x2="220" y2="100"/><line class="axis" x1="120" y1="20" x2="120" y2="180"/><g stroke="#9D9FA2" stroke-width="1.4"><line x1="35" y1="105" x2="55" y2="95"/><line x1="75" y1="105" x2="95" y2="95"/><line x1="115" y1="105" x2="135" y2="95"/><line x1="155" y1="105" x2="175" y2="95"/><line x1="195" y1="105" x2="215" y2="95"/><line x1="35" y1="65" x2="55" y2="55"/><line x1="75" y1="65" x2="95" y2="55"/><line x1="115" y1="65" x2="135" y2="55"/><line x1="155" y1="65" x2="175" y2="55"/><line x1="195" y1="65" x2="215" y2="55"/><line x1="35" y1="145" x2="55" y2="135"/><line x1="75" y1="145" x2="95" y2="135"/><line x1="115" y1="145" x2="135" y2="135"/><line x1="155" y1="145" x2="175" y2="135"/><line x1="195" y1="145" x2="215" y2="135"/></g><path class="curve" d="M 35 160 Q 120 100 215 30"/><text class="label" x="160" y="50">solution curve</text></svg><figcaption>Each tick shows the slope dy/dx at that point. A solution curve flows along the field.</figcaption></figure><div class="example"><div class="example-header">Example</div><p>For $\\frac{dy}{dx} = x$:</p><p>At $(1, 0)$: slope = 1</p><p>At $(2, 3)$: slope = 2</p><p>At $(-1, 5)$: slope = -1</p></div><div class="key-concept">Solution curves follow the direction of the slope field.</div>'
            },
            '7.4': {
                id: '7.4',
            ...
            '8.4': {
                ...
                content: '<h3>Area Between Curves</h3><div class="definition"><strong>Vertical Slices:</strong> If $f(x) \\geq g(x)$ on $[a,b]$: $$\\text{Area} = \\int_a^b [f(x) - g(x)]\\, dx$$</div><figure class="concept-figure"><svg viewBox="0 0 320 200" xmlns="http://www.w3.org/2000/svg"><line class="axis" x1="20" y1="170" x2="300" y2="170"/><line class="axis" x1="40" y1="20" x2="40" y2="190"/><path class="shaded" d="M 80 60 Q 170 30 260 90 Q 170 130 80 110 Z"/><path class="curve" d="M 50 80 Q 170 20 290 75"/><path class="curve-alt" d="M 50 130 Q 170 145 290 110"/><line class="helper-line" x1="80" y1="60" x2="80" y2="170"/><line class="helper-line" x1="260" y1="90" x2="260" y2="170"/><circle class="point" cx="80" cy="60" r="3"/><circle class="point" cx="260" cy="90" r="3"/><text class="label-axis" x="76" y="185">a</text><text class="label-axis" x="256" y="185">b</text><text class="label" x="240" y="50">f(x)</text><text class="label" x="240" y="125">g(x)</text></svg><figcaption>Area = (top &minus; bottom) integrated from a to b. The shaded region is what we accumulate.</figcaption></figure><div class="example"><div class="example-header">Example</div><p>Area between $y = x^2$ and $y = x$ from $x = 0$ to $x = 1$:</p><p>$\\int_0^1 (x - x^2)\\, dx = \\frac{1}{2} - \\frac{1}{3} = \\frac{1}{6}$</p></div><div class="key-concept">Top minus bottom, integrate over $x$.</div>'
            },
            '8.5': {
                id: '8.5',
            ...
            '8.7': {
                ...
                content: '<h3>Volumes by Cross Sections</h3><p>The Architects calculated the volume of stone needed for their structures.</p><div class="definition"><strong>General Formula:</strong> $$V = \\int_a^b A(x)\\, dx$$ where $A(x)$ is cross-sectional area.</div><figure class="concept-figure"><svg viewBox="0 0 320 200" xmlns="http://www.w3.org/2000/svg"><line class="axis" x1="20" y1="160" x2="300" y2="160"/><path class="shaded" d="M 60 160 L 60 110 Q 170 60 280 130 L 280 160 Z"/><path class="curve" d="M 60 110 Q 170 60 280 130"/><g stroke="#A30046" stroke-width="1.5" fill="#A30046" fill-opacity="0.2"><polygon points="120,160 120,90 145,160"/><polygon points="180,160 180,77 205,160"/><polygon points="240,160 240,108 265,160"/></g><line class="helper-line" x1="60" y1="160" x2="60" y2="180"/><line class="helper-line" x1="280" y1="160" x2="280" y2="180"/><text class="label-axis" x="56" y="195">a</text><text class="label-axis" x="276" y="195">b</text><text class="label" x="120" y="80">A(x) slice</text></svg><figcaption>Slice the solid perpendicular to the x-axis; each slice has area A(x). Integrate from a to b for total volume.</figcaption></figure><div class="example"><div class="example-header">Square Cross Sections</div><p>Base: region under $y = x$ from $x = 0$ to $x = 2$. Cross sections are squares with side $= y = x$.</p><p>$V = \\int_0^2 x^2\\, dx = \\frac{8}{3}$</p></div>'
            },
            '8.8': {
                id: '8.8',
            ...
            '8.9': {
                ...
                content: '<h3>Disc Method</h3><div class="definition"><strong>Around x-axis:</strong> $$V = \\pi\\int_a^b [f(x)]^2\\, dx$$</div><figure class="concept-figure"><svg viewBox="0 0 320 200" xmlns="http://www.w3.org/2000/svg"><line class="axis" x1="20" y1="100" x2="300" y2="100"/><path class="shaded" d="M 60 100 Q 170 25 280 65 L 280 100 Z"/><path class="shaded-alt" d="M 60 100 Q 170 175 280 135 L 280 100 Z"/><path class="curve" d="M 60 100 Q 170 25 280 65"/><path class="curve" d="M 60 100 Q 170 175 280 135"/><ellipse cx="170" cy="100" rx="6" ry="62" fill="none" stroke="#A30046" stroke-width="1.5" stroke-dasharray="3 3"/><ellipse cx="170" cy="100" rx="6" ry="62" fill="#A30046" fill-opacity="0.15"/><text class="label" x="135" y="95">disc slice</text><text class="label-axis" x="285" y="115">x</text></svg><figcaption>Spinning the curve around the x-axis sweeps out a solid; each thin disc has radius f(x), so dV = &pi;[f(x)]&sup2; dx.</figcaption></figure><div class="definition"><strong>Around y-axis:</strong> $$V = \\pi\\int_c^d [g(y)]^2\\, dy$$</div><div class="example"><div class="example-header">Example</div><p>$y = x^2$ from $x = 0$ to $x = 2$ rotated around x-axis:</p><p>$V = \\pi\\int_0^2 (x^2)^2\\, dx = \\pi\\int_0^2 x^4\\, dx = \\frac{32\\pi}{5}$</p></div>'
            },
            '8.10': {
                id: '8.10',
